...
<p style="font-size: 18px; line-height: 28px; text-align: center; margin: 0;"><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; font-size: 24px;">Notifications From InternMasters! </span><br/></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 12px; line-height: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px; color:#262626;">Hi, <?php echo $userName; ?> </span></strong></span></p>
<p style="font-size: 12px; line-height: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px; color:#262626;">Your project  <br> Project title - <?php echo $project_name ?></span></strong></span></p>
<p style="font-size: 12px; line-height: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px; color:#262626;">Project Function - <?php echo $project_function ?></span></strong></span></p>
<p style="font-size: 12px; line-height: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px; color:#262626;">Has been approved By program champion</span></strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 12px; line-height: 21px; margin: 0;"><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; font-size: 14px;">Please Click the following Link Login your profile and See the approved Projects</span><br/></p>
<p>
	<a href="<?php echo $url ?>">
		<button style="color:white; border:none; border-radius:3px; background:#3AAEE0; cursor:pointer; padding:4px 12px;">
			Click Here to Login
		</button>
	</a>
</p>
