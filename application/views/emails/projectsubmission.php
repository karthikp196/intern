...
<p style="font-size: 12px; line-height: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px; color:#262626;">There is a New project has been Submitted <br> Project title - <?php echo $project_title ?></span></strong></span></p>
