...
<p style="font-size: 12px; line-height: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px; color:#262626;">Hi, <?php echo $champion; ?> </span></strong></span></p>
<p style="font-size: 12px; line-height: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px; color:#262626;">There is a new survey result has been submitted by <?php echo $intern ?> </span></strong></span></p>
...
<p>
	<a href="<?php echo $url ?>">
		<button style="color:white; border:none; border-radius:3px; background:#3AAEE0; cursor:pointer; padding:4px 12px;">
			Click Here to Login and review the survey
		</button>
	</a>
</p>
