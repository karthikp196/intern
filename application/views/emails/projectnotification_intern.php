...
<p style="font-size: 12px; line-height: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px; color:#262626;">Dear <?php echo $userName; ?> </span></strong></span></p>
<p style="font-size: 12px; line-height: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px; color:#262626;">There is a New project has been assigned to you <br> Project title - <?php echo $project_name ?></span></strong></span></p>
...
<p style="font-size: 12px; line-height: 21px; margin: 0;"><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; font-size: 14px;">Please Click the following Link Login your profile and See the project details</span><br/></p>
<p>
	<a href="<?php echo $url ?>">
