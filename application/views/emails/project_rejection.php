...
<p style="font-size: 12px; line-height: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px; color:#262626;">Hi, <?php echo $sponsor; ?> </span></strong></span></p>
<p style="font-size: 12px; line-height: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px; color:#262626;">Your Project <br> Project title - <?php echo $project_name ?> has been rejected for the Following Reason</span></strong></span></p>
<p style="font-size: 12px; line-height: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px; color:#262626;">Reason for Rejection - </span></strong></span></p>
...
<p style="font-size: 12px; line-height: 21px; margin: 0;"><span style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; font-size: 14px;">Please Click the following Reapply the Project</span><br/></p>
<p>
	<a href="<?php echo $url ?>">
