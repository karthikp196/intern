    ...
    <section class="login-form">
        ...
        <div class="elem-container">
            ...
            <form id="" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="email"><input type="email" id="inte_r" class="" name="password" placeholder="Email" />
                ...
                <div><input type="submit" name="sign-in" class="intern_flink" id="" value="Send reset link" />
                </div>
            </form>
