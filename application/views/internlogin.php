    ...
    <section class="login-form">
        ...
        <div class="elem-container">
            ...
            <form id="" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="email"><input type="email" id="int_email" class="" name="password" placeholder="Email" />
             
                </div>
                <div class="password"><input type="password" id="int_pass" class="" name="cpassword" placeholder="password" />
                <input type="checkbox" class="class_checkbox1">
                ...
                <div><input type="submit" name="sign-in" id="int_login" value="Sign In" />
                </div>
            </form>
            <div>
